...
# Note the new Leave Management tab
...
with tab_leave:
  ...
  if staff_df.empty:
    ...
    # Filter all attendance strictly for the current calendar year
    ...
    # Use Progress Bars for remaining quotas
    st.dataframe(
        leave_df,
        use_container_width=True,
        hide_index=True,
